...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-09HOAGV3;Initial Catalog=farmacia;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Medicamentos>(entity =>
            {
                ...
                entity.Property(e => e.FrecuenciaDeTomaHr).HasColumnName("FrecuenciaDeTomaHR");

                entity.Property(e => e.Nombre).IsRequired();

                entity.Property(e => e.Presentacion).IsRequired();
